...
export default function Footer() {
  return (
      <footer id={styles.m_footer}>
        <div id={styles.footer_contents}>
        <div id={styles.footer_box}>
      
      <div id={styles.footer_ul_box}>
       <div id={styles.footer_header}>
        <a href='/'>Customer service</a>
        </div> 
        <ul id={styles.footer_list}>
          <li>Contact us</li>
